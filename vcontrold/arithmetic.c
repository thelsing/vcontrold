...
/* $Id: arithmetic.c 34 2008-04-06 19:39:29Z marcust $ */
...
float execFactor(char **str, unsigned char *bPtr, float floatV, char *err) {
    ...
    int n;
    switch (nextToken(str, &item, &n)) {
    case BYTE0: return(bPtr[0]);
    case BYTE1: return(bPtr[1]);
    case BYTE2: return(bPtr[2]);
    case BYTE3: return(bPtr[3]);
    case BYTE4: return(bPtr[4]);
    case BYTE5: return(bPtr[5]);
    case BYTE6: return(bPtr[6]);
    case BYTE7: return(bPtr[7]);
    case BYTE8: return(bPtr[8]);
    case BYTE9: return(bPtr[9]);
    case VALUE: return(floatV);
    case HEX:
        nPtr = nstring;
...
int execIFactor(char **str, unsigned char *bPtr, char bitpos, char *pPtr, char *err) {
    ...
    int n;
    switch (nextToken(str, &item, &n)) {
    case BYTE0: return(((int)bPtr[0]) & 0xff);
    case BYTE1: return(((int)bPtr[1]) & 0xff);
    case BYTE2: return(((int)bPtr[2]) & 0xff);
    case BYTE3: return(((int)bPtr[3]) & 0xff);
    case BYTE4: return(((int)bPtr[4]) & 0xff);
    case BYTE5: return(((int)bPtr[5]) & 0xff);
    case BYTE6: return(((int)bPtr[6]) & 0xff);
    case BYTE7: return(((int)bPtr[7]) & 0xff);
    case BYTE8: return(((int)bPtr[8]) & 0xff);
    case BYTE9: return(((int)bPtr[9]) & 0xff);
    case BITPOS: return(((int)bitpos) & 0xff);
    case PBYTE0: return(((int)pPtr[0]) & 0xff);
    case PBYTE1: return(((int)pPtr[1]) & 0xff);
    case PBYTE2: return(((int)pPtr[2]) & 0xff);
    case PBYTE3: return(((int)pPtr[3]) & 0xff);
    case PBYTE4: return(((int)pPtr[4]) & 0xff);
    case PBYTE5: return(((int)pPtr[5]) & 0xff);
    case PBYTE6: return(((int)pPtr[6]) & 0xff);
    case PBYTE7: return(((int)pPtr[7]) & 0xff);
    case PBYTE8: return(((int)pPtr[8]) & 0xff);
    case PBYTE9: return(((int)pPtr[9]) & 0xff);
    case HEX:
        nPtr = nstring;
        bzero(nstring, sizeof(nstring));
        strcpy(nstring, "0x");
    ...
    *count = 1;
    ...
    case 'B':
        *count = 2;
        ...
        case '8': return(BYTE8);
        case '9': return(BYTE9);
        case 'P': return(BITPOS);
        }
    case 'P':
        *count = 2;
        switch (*(*str)++) {
        case '0': return(PBYTE0);
        case '1': return(PBYTE1);
        case '2': return(PBYTE2);
        case '3': return(PBYTE3);
        case '4': return(PBYTE4);
        case '5': return(PBYTE5);
        case '6': return(PBYTE6);
        case '7': return(PBYTE7);
        case '8': return(PBYTE8);
        case '9': return(PBYTE9);
        }
