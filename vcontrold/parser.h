...
int execByteCode(compilePtr cmpPtr, int fd, char *recvBuf, size_t recvLen, char *sendBuf, size_t sendLen, short supressUnit, char bitpos, int retry, char *pRecvPtr, unsigned short recvTimeout);
